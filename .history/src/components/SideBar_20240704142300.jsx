  ...
  return (
    <div className='w-1/4 bg-[#0085FF] rounded-r-3xl'>
          ...
          <div className='flex flex-col items-center font-bold text-white py-20 mt-10'>
            ...
            <Link className='hover:border border-gray-200 rounded-full py-2 px-14 hover:bg-gray-100 hover:text-[#0085FF] inline-block mr-10' to='/teachers'><FaChalkboardTeacher className='inline-block  mr-5  text-2xl'/>{t('clas')}</Link>
