    ...
    <div>
      ...
      {activeSection && (
        <div>
          ...
          <UploadCenter text={"Attendance"} color={"bg-gray-500"} info={"upload semester attendance in excel file"} />
          <UploadCenter text={"Grade"} color={"bg-yellow-700"} info={"upload semester attendance in excel file"} />
          </div>
