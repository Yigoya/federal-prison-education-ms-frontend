...
const InstructorDetails = () => {
  return (
    <div className="m-4 bg-sky-100 w-fit p-2 w-2/5 rounded-2xl relative">
      {/* Main content */}
      ...
      {/* Additional info */}
      <div className="bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-xl w-full p-3 leading-3.5 mt-4">
